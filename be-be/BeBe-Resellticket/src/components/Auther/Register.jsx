    ...
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            onClick={() => navigate("/login")}
            className="font-medium text-blue-500 hover:underline hover:text-primary"
          >
            Log in
          </button>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="relative flex flex-col">
            <label className="mb-2 text-sm font-medium text-black text-gray-700">
              Password (*)
            </label>
            <input
          ...
          <div className="mt-4 text-center">
            <span
              className="cursor-pointer text-third hover:underline hover:text-secondary"
              onClick={() => navigate("/")}
            >
              &#60;&#60; Go to HomePage
            </span>

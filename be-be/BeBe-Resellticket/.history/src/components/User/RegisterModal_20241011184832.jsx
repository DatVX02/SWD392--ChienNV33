      ...
      <div className="relative w-full max-w-md p-8 bg-white rounded-lg shadow-lg z-60">
        ...
        <div className="flex flex-col items-center mb-6">
          <img
            src={LogoTicket}
            alt="Logo"
            className="w-24 h-24 rounded-lg shadow-lg" // Updated width and height to 24 (96px), changed border-radius to 'rounded-lg' for more size
          />
          <h2 className="text-3xl font-bold text-green-600">Register</h2>{" "}
          {/* Updated font size to 3xl for a larger look */}
        </div>

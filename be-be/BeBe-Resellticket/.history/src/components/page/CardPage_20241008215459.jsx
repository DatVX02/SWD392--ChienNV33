...
import MovieCard {TicketCardSkeleton} from "../components/movie/MovieCard";
import ReactPaginate from "react-paginate";
import { v4 } from "uuid";
import { TicketCardSkeleton } from "../ticket/TicketCard";
...
const CardPage = () => {
  ...
  const pageCount = Math.ceil(filterMovies.length / itemsPerPage);

...
import SearchBar from "../../banner/SearchBar"; // Adjusted import path
import TicketList from "../../ticket/TicketList"; // Adjusted import path
import Banner from "../../banner/Banner"; // Adjusted import path
import Header from "../../layout/Header"; // Adjusted import path
import LoginModal from "../../User/LoginModal"; // Adjusted import path
import RegisterModal from "../../User/RegisterModal"; // Adjusted import path

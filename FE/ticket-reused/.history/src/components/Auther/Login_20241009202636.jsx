      ...
      <div className="w-full max-w-md p-8 bg-white rounded-md shadow-lg">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-center">
            <button
              className="flex items-center justify-center w-full px-4 py-2 font-semibold text-white transition duration-300 rounded-md bg-primary hover:bg-blue-600 disabled:opacity-50"
              onClick={handleLogin}
              disabled={isLoading}
            >
              {isLoading && (
